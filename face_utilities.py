...
class Face_utilities():
    ...
    def get_landmarks(self, frame, type):
        ...
        if self.predictor is None:
            ...
            self.predictor = dlib.shape_predictor("C:/Users/kik/OneDrive/เดสก์ท็อป/Heart-rate-measurement-using-camera/new_update/shape_predictor_" + type + "_face_landmarks.dat")
            #self.predictor = dlib.shape_predictor("C:/Users/kik/OneDrive/เดสก์ท็อป/Heart-rate-measurement-using-camera/new_update/shape_predictor_68_face_landmarks.dat")
